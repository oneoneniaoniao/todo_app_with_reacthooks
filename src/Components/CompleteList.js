...
const CompleteList = () => {
    ...
    return (
      <div className="m-12">
        <h3 className="text-2xl inline-block">完了したToDo</h3>
                 <button className="text-sm ml-8 bg-red-300 text-white rounded-lg p-1 px-2 m-1 hover:bg-red-500" onClick={deleteAllCompleteTodos} disabled={state.completeTodos.length === 0}>全ての完了したToDoを削除する</button>
        <table className="m-4">
        <thead>
            <tr>
